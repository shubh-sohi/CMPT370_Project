...
//$check_nameF==TRUE && $check_nameL==TRUE && $check_email==TRUE && $check_phone==TRUE && $check_pass=TRUE
        $query3 = "insert INTO user (first_name,last_name,password,email,phone) VALUES 
			('$first_name','$last_name','$password_hash','$p_email','$p_phone')";
        //echo $query3;

        if ($connect->query($query3) === TRUE) {
            $id_n = "id";
            $showname = "id2";
            $id2 = $first_name . " " . $last_name;
            setcookie($showname, $id2, time() + (86400 * 30), "/"); // 86400 = 1 day
    ...
    <div class="tab-content">
        <div id="signup">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="field-wrap">
                    <label for="pnumber">PHONE NUMBER<span class="req">Format:"1234567896" *</span></label>
        ...
        <p style="color: #767676; font-size: 25px">ALREADY HAVE AN ACCOUNT?
            <a style="color: #DE5F5F; font-size: 25px" href="../log-in/login.php" target="blank">LOG IN</a>
    </div><!-- tab-content -->
</div> <!-- /form -->
</body>
